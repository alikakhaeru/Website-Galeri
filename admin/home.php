...
<body>
                    ...
                    <div class="col-md-3 mt-2">
                        <div class="card">
                            ...
                            <div class="card-footer text-center">
                                ...
                                ?>
                                <a href=""><i class="fa-regular fa-comment"></i></a> <?php echo mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM komentarfoto WHERE fotoid='$fotoid'")) ?> Komentar
                            </div>
                        </div>
                    </div>
    ...
    <footer class="d-flex justify-content-center border-top mt-3 bg-light fixed-bottom">
        <p style>&copy; UKK RPL 2024 | Alika Khaeru</p>
    </footer>
